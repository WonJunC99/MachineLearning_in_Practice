...
// macOS / Linux: Windows 전용 타입 직접 정의
using BYTE  = uint8_t;
using WORD  = uint16_t;
...
#define LOG_OUT(_x_)   fprintf(stderr, "%s\n", (const char*)(_x_))
#define LOG_OUT_W(_x_) fprintf(stderr, "%ls\n", (const wchar_t*)(_x_))
#define LOG_OUT_A(_x_) fprintf(stderr, "%s\n", (const char*)(_x_))
